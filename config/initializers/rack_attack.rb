...
# This class configures when and how different clients are throttled, and for how long.
class Rack::Attack
  ### Configure Cache ###
...
ActiveSupport::Notifications.subscribe(/rack_attack/) do |name, start, finish, request_id, _payload|
